    ...
    <div class="p-4 py-8 mx-auto max-w-screen-xl md:p-8 lg:p-10">
        <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
            <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400">
                    ...
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Doa</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Hadist</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Al Qur'an</a>
                    </li>
                    <li class="mb-4">
            ...
            <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400">
                    ...
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Muhammad Reza</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Pratisena Bhadrika</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Raditya Meyka</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="text-center">
            ...
            <ul class="flex justify-center mt-5 space-x-5">
                ...
                <li>
                    <a href="https://github.com/ibrahimrangkuti"
                        class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
